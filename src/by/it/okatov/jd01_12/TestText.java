...
public class TestText {
    public static final String text1 = (
            "Fortunately, the London Eye, the city’s famous Ferris wheel, " +
                    "was open to the public. The London Eye is situated along" +
                    " the southern shores of the Thames River. This attraction stands " +
                    "135 meters high. It is one of London’s most well-known spots for " +
                    "gaining aerial views of the city. Each capsule of the Ferris" +
                    " wheel can hold up to twenty five passengers. When their capsule stopped" +
                    " at the top of the Ferris wheel, the women took spectacular " +
                    "panoramic photographs of the beautiful cityscape below.\n" + "\n" +
                    "The last place that Rita and Joanne visited was Buckingham " +
                    "Palace, the home of the Queen of England. The women were " +
                    "impressed by the palace’s incredible architecture and " +
                    "historical value. Both Rita and Joanne enjoyed watching the " +
                    "Queen’s guards outside the palace. These guards wore red tunic " +
                    "uniforms, shiny black boots, and bearskin hats. Despite the women’s " +
                    "attempts to catch the attention of the guards, the guards are " +
                    "specifically trained to avoid distractions. Because of this, " +
                    "the guards ignored the women completely." +
                    "end"
    );
