...
public class Test_for_calc {
    ...
    private static Test_for_calc run(String in) {
        return run(in, true);
    }

    private static Test_for_calc run(String in, boolean runMain) {
        ...
        System.out.println("---------------------------------------------");
        return new Test_for_calc(clName, in, runMain);
    }

    //-------------------------------  тест ----------------------------------------------------------
    public Test_for_calc() {
        //Конструктор тестов
    }
    ...
    private Test_for_calc(String className, String in, boolean runMain) {
